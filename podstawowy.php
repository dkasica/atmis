...
if ($today <= $_SESSION['podstawa']) {
    ...
    $total_pages_sql = "SELECT COUNT(*) FROM podstawa";
        ...
        <div id="content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <?php
                    if ($today <= $_SESSION['podstawa']) {
                    $sql = "SELECT * FROM podstawa LIMIT $offset, $no_of_records_per_page";
                ...
                } else {echo '<h3>Nie masz dostępu do tej części materiałów.</h3>';}
                    ?>
                </div>
            </div>
        </div>
